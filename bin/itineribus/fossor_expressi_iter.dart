...
Future<Response> fossorExpressi(Request req) async {
  ...
  try {
    ...
    lttip.addAll(ltsr);
    COE coe = await COE.computo(victimaPrimis: ip.victima.primis, inimicusPrimis: inimicusPrimis, maxime: 10000000, ex: ip.ex, prior: prior, gladiatorVictima: gladiatorVictima, gladiatorInimicus: gladiatorInimicus, llt: lttip, lo: lo);
